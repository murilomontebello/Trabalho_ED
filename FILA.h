...
No* verificaAtraso(){
    ...
    int mes_atual = data_atual->tm_mon + 1; // Adicionar 1 porque janeiro é 0
    int ano_atual = data_atual->tm_year + 1900; // Adicionar 1900 para obter o ano correto
...
void imprimeConcluido(No *aux){

    No *q = aux;
    No *j = aux;

    printf("Concluidas com atrasos: ");
    if(q!=NULL){
